...
<div id="page-wrapper">
	<div class="row">
		...
		<div class="col-lg-12">
			<div class="col-lg-12">
				<button  class="btn btn-success btn" onclick="showForm()" >
					Nueva Poliza
				</button>
			&nbsp;&nbsp;
				<button class="btn btn-warning btn" data-toggle="modal" data-target="#myModal">
					Obtener Datos
				</button>
			</div>	
	...
	<div class="row" style="margin-top: 20px;">
		<form role="form" action="<?=base_url() ?>index.php/formularioEmision/guardarCertificado" method="post" accept-charset='UTF-8' id="form-create-certificate">
			<div class="col-lg-12">
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="col-lg-4">
								<div class="form-group">
									<label>Póliza</label>
										<select class="form-control" id="idPoliza" name="idPoliza" required>
											<option value="">Seleccione</option>
										</select>
								</div>
							</div>
							...
							<div class="col-lg-4">
								<div class="form-group">
									<label>Dirección</label>
										<input class="form-control" placeholder="ej: las margaritas 2145, santiago, chile." id="idDireccion" name="idDireccion"  required>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="form-group">
									<label>Referencia Interna</label>
										<input class="form-control" placeholder="Referencia Interna" id="idRefInterna"  name="idRefInterna" required>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="col-lg-4">
								<div class="form-group">
									<label>Deducible</label>
										<input type="number" step="0.01" class="form-control" placeholder="ej:1% del monto asegurado con un minimo de usd 50" 
							...
							<div class="col-lg-4">
								<div class="form-group">
									<label>Monto Asegurado</label>
										<input class="form-control" placeholder="ej: 250.000" id="idMontoAsegurado" name="idMontoAsegurado" required>
								</div>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="col-lg-4">
								<div class="form-group">
									<label>Tasa</label>
										<input class="form-control" step="0.01" placeholder="ej: 0.5" id="idTasa" name="idTasa" required>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="form-group">
									<label>Clausula</label>
										<select class="form-control" id="idClausula" name="idClausula" required>
										<option value="">Seleccione</option>
											<?php
							...
							<div class="col-lg-4">
								<div class="form-group">
									<label>Prima</label>
										<input class="form-control" placeholder="ej: 250.000" id="idPrima" name="idPrima" required>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-12">
							<div class="col-lg-4">
								<div class="form-group">
									...
									<div class='input-group date'>
											<input type='date' class="form-control" id="idFechaEmbarque" name="idFechaEmbarque" required>
							...
							<div class="col-lg-4">
								<div class="form-group">
									...
									<div class='input-group date'>
											<input type="date" class="form-control" id="idFechaArribo" name="idFechaArribo" required>
										<span class="input-group-addon">
											<span class="glyphicon glyphicon-calendar"></span>
										</span>
									</div>
							...
							<div class="col-lg-4">
								<div class="form-group">
									<label>Guía o BL</label>
										<input class="form-control" placeholder="ej: 445454548" id="idGuiaBl" name="idGuiaBl" required>
								</div>
							</div>
						</div>
							...
							<div class="col-lg-4">
								<div class="form-group">
									<label>Nombre Linea Aerea/Compañia naviera</label>
										<input class="form-control" placeholder="ej: Latam" id="idNomLineaNave" name="idNomLineaNave" required>
								</div>
							</div>
							...
							<div class="col-lg-4">
								<div class="form-group">
									<label>Nombre Nave/Motonave</label>
										<input class="form-control" placeholder="ej: Santa Barbara" id="idNomNave" name="idNomNave" required>
								</div>
							</div>
							...
							<div class="col-lg-4">
								<div class="form-group">
									<label>Numero Vuelo/Nave</label>
										<input class="form-control" placeholder="ej: 123456" id="idNumVueloNave" name="idNumVueloNave" required>
								</div>
							</div>
							...
							<div class="col-lg-6">
								<div class="form-group">
									<label>Tipo de Embalaje</label>
										<select class="form-control" id="idTipoEmbalaje" name="idTipoEmbalaje" required>
										<option value="">Seleccione</option>
											<?php
							...
							<div class="col-lg-4">
								<div class="form-group">
									<label>Transporte</label>
										<select class="form-control" id="idTransporte" name="idTransporte" required>
										<option value="">Seleccione</option>
											<?php
							...
							<div class="col-lg-6">
								<div class="form-group">
									<label>Descripción de la Mercadería</label>
										<textarea class="form-control" rows="3" id="idDescMercaderia" name="idDescMercaderia" required></textarea>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="col-lg-4">
								<div class="form-group">
									<label>Pais</label>
										<select class="form-control" id="idPaisOrigen" name="idPaisOrigen" required>
										<option value="">Seleccione</option>
												<?php
							...
							<div class="col-lg-4">
								<div class="form-group">
									<label>Ciudad</label>
										<select class="form-control" id="idCiudadOrigen" name="idCiudadOrigen" required>
											<option value="">Seleccione</option>
										</select>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="form-group">
									<label>Puerto</label>
										<input class="form-control" placeholder="ej: Puerto de san antonio" id="idPuertoOrigen" name="idPuertoOrigen" required>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="col-lg-4">
								<div class="form-group">
									<label>Pais</label>
										<select class="form-control" id="idPaisDestino" name="idPaisDestino" required>
											<option value="">Seleccione</option>
												<?php
												foreach ($arrPaises as $index => $key) {
													echo '<option value="'.$key["id_pais"].'">'.$key["nombre_pais"].'</option>';
							...
							<div class="col-lg-4">
								<div class="form-group">
									<label>Ciudad</label>
										<select class="form-control" id="idCiudadDestino" name="idCiudadDestino" required>
											<option value="">Seleccione</option>
										</select>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="form-group">
									<label>Puerto</label>
										<input class="form-control" placeholder="ej: Puerto de san antonio" id="idPuertoDestino" name="idPuertoDestino" required>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="col-lg-12 " style="margin-bottom: 40px;">
						<div class="form-group">
							<button type="submit" class="btn btn btn-success">Emitir</button>
							</div>
						<div class="form-group">
							<button id="btnModalUpd" name="btnModalUpd" type="button" class="btn btn btn-primary" data-toggle="modal" data-target="#myModalUpdate" disabled="true">Actualizar</button>
						</div>

						<div class="form-group">
							<button id="btnModalEli" name="btnModalEli" type="button" class="btn btn btn-danger" data-toggle="modal" data-target="#myModalDelete" disabled="true">Eliminar</button>
						</div>
			</div>
		</div>
					...
					<div class="row"  style="text-align:center;">
						<div class="col-lg-12">
							...
							<div class="col-lg-12">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;
									<button type="button" class="btn btn-primary" id="btnActualizarCertificado" name="btnObtieneDatos"
